...
const stockData = [
  ...
  { 
    name: 'MATRIX GAS', 
    price: 870, 
    image: 'https://images.unsplash.com/photo-1622178757222-9075f85315c4?q=80&w=1000' 
  },
  { 
    name: 'RRP', 
    price: 320, 
  ...
  { 
    name: 'NAYARA', 
    price: 620, 
    image: 'https://images.unsplash.com/photo-1565108690533-32a7f64e2738?q=80&w=1000' 
  },
  { 
    name: 'SBI CARDS', 
    price: 2800, 
    ...
    <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto px-4">
        <div className="flex items-center gap-4 mb-12">
          <ArrowTrendingUpIcon className="w-10 h-10 text-[#04dd2a]" />
          <div>
              ...
              <div className="p-6">
                <div className="flex gap-3">
                  <motion.button
                    ...
                    className="flex-1 bg-[#04dd2a] text-white py-3 rounded-lg 
                             hover:bg-[#04dd2a]/90 transition-colors
                             font-semibold shadow-lg shadow-[#04dd2a]/20"
                  >
                    Buy Now
                  </motion.button>
                  <motion.button
                    ...
                    className="flex-1 border-2 border-[#04dd2a] text-[#04dd2a] py-3 
